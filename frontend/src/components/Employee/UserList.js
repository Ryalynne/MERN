    ...
    setEditedData((prev) => {
      ...
      if (field === "job_id") {
        fetchPositionsForJob(value).then(() => {
          ...
          setEditPositionSearch(""); // Reset position search when job changes
        });
      }
      if (field === "salary_id") {
  ...
  const handleNewChange = (e, field) => {
    ...
    setNewEmployee((prev) => {
      ...
      if (field === "job_id") {
        ...
        newData.salary_id = "";
        setAddPositionSearch(""); // Reset position search when job changes
      }
      return newData;
    });
    setAddErrors((prev) => ({
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="control">
                        ...
                        />
                        <div className={`select is-fullwidth ${addErrors.job_id ? "is-danger" : ""}`}>
                          <select
                    ...
                    <td>
                      <div className="control">
                        ...
                        />
                        <div className={`select is-fullwidth ${addErrors.salary_id ? "is-danger" : ""}`}>
                          <select
                          ...
                          >
                            ...
                            {loadingPositions[newEmployee.job_id] ? (
                              ...
                              getFilteredPositions(newEmployee.job_id, addPositionSearch).map((pos) => (
                      ...
                      <td>
                        {editRow === user.id ? (
                          <div className="control">
                            ...
                            />
                            <div className={`select is-fullwidth ${editErrors.job_id ? "is-danger" : ""}`}>
                              <select
                              ...
                              >
                                <option value="">Select Job Title</option>
                                {getFilteredDepartments(editJobSearch).map((dep) => (
                                  <option key={dep.id} value={dep.id.toString()}>
                                    {dep.Job_Title}
                                  </option>
                                ))}
                        ...
                        {editRow === user.id ? (
                          <div className="control">
                            <input
                              ...
                              onChange={(e) => setEditPositionSearch(e.target.value)}
                              disabled={!editedData.job_id}
                            />
                            <div className={`select is-fullwidth ${editErrors.salary_id ? "is-danger" : ""}`}>
                              <select
                              ...
                              >
                                ...
                                {loadingPositions[editedData.job_id] ? (
                                  ...
                                  getFilteredPositions(editedData.job_id, editPositionSearch).map((pos) => (
                                    <option key={pos.id} value={pos.id.toString()}>
                                      {pos.position}
                                    </option>
                                  ))
