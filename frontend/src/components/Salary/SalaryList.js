                  ...
                  <tr>
                    ...
                    <td>
                      <div className="control">
                        ...
                        />
                        <div className={`select is-fullwidth ${addErrors.dep_id ? "is-danger" : ""}`}>
                          <select
                            value={newSalary.dep_id}
                            onChange={(e) => handleNewChange(e, "dep_id")}
                            style={{ height: "100px" }} // Optional: ensures visibility
                          >
                    ...
                    <td>
                      <div className="buttons">
                        <button className="button is-small is-success" onClick={saveNewSalary}>
                          Save
                        </button>
                        <button
                    ...
                    <td>
                      {editingId === user.id ? (
                        <div className="control">
                          ...
                          />
                          <div className={`select is-fullwidth ${editErrors.dep_id ? "is-danger" : ""}`}>
                            <select
